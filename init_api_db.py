...
def init_saas_schema():
    ...
    try:
        ...
        ensure_column(cursor, "webhooks", "secret", "TEXT")
        ensure_column(cursor, "webhooks", "profile_name", "TEXT DEFAULT 'broker_alerts_v1'")
        ensure_column(cursor, "webhooks", "site_filter", "TEXT")
        ensure_column(cursor, "webhooks", "type_filter", "TEXT")
        ensure_column(cursor, "webhooks", "category_filter", "TEXT")
        ...
        ensure_column(cursor, "webhooks", "retry_count", "INTEGER DEFAULT 3")
        ensure_column(cursor, "webhooks", "timeout_seconds", "INTEGER DEFAULT 30")
        ensure_column(cursor, "webhooks", "success_count", "INTEGER DEFAULT 0")
        ensure_column(cursor, "webhooks", "failure_count", "INTEGER DEFAULT 0")
        ...
        ensure_column(cursor, "webhooks", "last_triggered", "TIMESTAMP")
        ensure_column(cursor, "webhooks", "last_success", "TIMESTAMP")
        ensure_column(cursor, "webhooks", "last_failure", "TIMESTAMP")
        ...
        ensure_column(cursor, "webhooks", "last_error", "TEXT")
        ensure_column(cursor, "webhooks", "updated_at", "TIMESTAMP DEFAULT CURRENT_TIMESTAMP")
